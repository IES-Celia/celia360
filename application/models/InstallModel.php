    ...
    class InstallModel extends CI_Model {
        ...
        ******************************************************************/
        ...
        public function entradas(){
            $this->db->query("CREATE TABLE `audio` (
            ...
            $this->db->query("CREATE TABLE `celda_pd` (
            ...
            $this->db->query("CREATE TABLE `escenas_hotspots` (
                            `id_escena` int(11) NOT NULL,
                            `id_hotspot` int(11) NOT NULL
                            ) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;");
            
            $this->db->query("CREATE TABLE `hotspots` (
                            `id_hotspot` int(11) NOT NULL,
            ...
            $this->db->query("CREATE TABLE `imagenes` (
            ...
            $this->db->query("CREATE TABLE `libros` (
            ...
            $this->db->query("CREATE TABLE `opciones_portada` (
            ...
            $this->db->query("CREATE TABLE `panel_imagenes` (
                            `id_hotspot` int(11) NOT NULL,
                            `id_imagen` int(11) NOT NULL
                            ) ENGINE=MyISAM DEFAULT CHARSET=utf8;");

            $this->db->query("CREATE TABLE `panel_informacion` (
                            `id_documento` int(11) NOT NULL,
                            `documento_url` varchar(255) NOT NULL
                            ) ENGINE=MyISAM DEFAULT CHARSET=utf8;");

            $this->db->query("CREATE TABLE `pisos` (
                            `piso` int(1) NOT NULL,
            ...
            $this->db->query("CREATE TABLE `puntos_mapa` (
