...
<div class='container'>
    ...
    <div class="row">
	    ...
	    <h5 class="text-center">(en orden alfabético)</h5>
            <ul class="list-group">
                ...
                <li class="list-group-item">
                <p class="d-inline" >Miguel Ángel López Segura </p>
                ...
                <li class="list-group-item">
                    <p class="d-inline">Daniel Sánchez Gil</p>
